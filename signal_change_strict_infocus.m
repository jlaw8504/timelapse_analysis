function [ lengthMat, changeMat, normMat ] = signal_change_strict_infocus( directory,...
...
for n = 1:length(files)
    ...
    %also convert any cells lacking a spindle length
    spindle_empty = cellfun(@isempty,spindle);
    major_axes(major_axes_empty | spb_distal | spindle_empty)={nan};
