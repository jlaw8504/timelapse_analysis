function [ ensemble_spindle_mean, ensemble_spindle_std, spindle_means, spindle_stds ]...
    = timelapse_spindle_std_stretch_only_1to3um_only( directory, threshold )
...
for n = 1:length(files)
    ...
    spindle_gt3000 = cellfun(@(x) x > 3000,spindle_length);
    spindle_exclude = spindle_lt1000 | spindle_gt3000;
