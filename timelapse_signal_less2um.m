function [ ensemble_mean, ensemble_var, means_axis, var_axis, major_axes ]...
    = timelapse_signal_less2um( directory, threshold )
...
for n = 1:length(files)
    ...
    %find spindles less than 500 nm
    spindle_1000 = spindle_lengths < 1000;
    %find spindles greater than 2000 nm
